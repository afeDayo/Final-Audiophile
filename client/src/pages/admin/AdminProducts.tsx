...
const AdminProducts: React.FC = () => {
  ...
  return (
    <div className="p-6 md:p-8 lg:p-10 animate-[fadeIn_0.4s_ease-in]">
      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        <h1 className="font-bold text-2xl md:text-3xl text-black">Products</h1>
        <button
          onClick={openCreateModal}
          className="flex items-center gap-2 bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase px-8 py-4 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer"
        >
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-white rounded-2xl w-full max-w-175 p-8 animate-[fadeIn_0.4s_ease-in] my-auto"
          ...
          >
            ...
            <div className="flex gap-4 mt-8">
              ...
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="flex-1 bg-[#D87D4A] text-white font-bold text-[13px] tracking-[1px] uppercase px-8 py-4 hover:bg-[#FBAF85] transition-colors duration-200 cursor-pointer disabled:opacity-60"
              >
                {isSaving
                  ? "Saving..."
                  : editingProduct
      ...
      {deleteConfirm && (
        <div
          ...
          style={{ backgroundColor: "rgba(0,0,0,0.5)" }}
        >
          <div className="bg-white rounded-2xl p-8 max-w-100 w-full text-center animate-[fadeIn_0.4s_ease-in]">
