...
// Axios is like a better version of fetch() - it automatically
...
const BASE_URL =
  import.meta.env.VITE_API_URL || "https://final-audiophile.onrender.com/api";
...
// ------ REQUEST INTERCEPTOR ----
// Runs before every request - we use it to add the JWT token to headers
